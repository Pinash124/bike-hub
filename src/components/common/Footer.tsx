...
export default function Footer() {
  return (
    <footer className="bg-[#0f172a] text-white mt-40 border-t border-white/5 w-full font-sans">
      ...
      {/* py-40 tạo khoảng trống trên dưới rộng rãi, sang trọng */}
      <div className="content-layout py-40">
        
        {/* Grid nội dung với gap-20 để các cột cách xa nhau hơn */}
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-20 items-start">
          ...
          {/* CỘT 2: Hỗ trợ khách hàng - ĐÃ THẲNG HÀNG & CÁCH XA NHAU */}
          <div className="space-y-14 lg:pl-10">
            {/* pl-7 để tiêu đề thẳng hàng với text bên dưới icon */}
            <h5 className="font-bold text-[12px] text-green-500 uppercase tracking-[0.3em] pl-7">
              Hỗ trợ khách hàng
            </h5>
            
            <div className="space-y-14">
              {/* pl-7 để Hotline thẳng hàng tuyệt đối */}
              <div className="pl-7">
                ...
                {['Câu hỏi thường gặp', 'Chính sách bảo hành', 'Quy trình kiểm định', 'Chính sách bảo mật'].map(item => (
                  <li key={item}>
                    <a href="#" className="hover:text-white transition-all duration-300 flex items-center gap-3 group">
                      ...
                      {/* Text bắt đầu sau icon, thẳng hàng với tiêu đề ở trên */}
          ...
          {/* CỘT 3: Cơ hội hợp tác - Xóa bo góc khối, bo góc chữ & nút */}
          <div className="space-y-10 lg:pl-10">
            <h5 className="font-bold text-[12px] text-green-500 uppercase tracking-[0.3em]">Cơ hội hợp tác</h5>
            
            <div className="bg-white/5 p-8 rounded-none border border-white/10 group cursor-pointer hover:bg-white/10 transition-all duration-500">
              <div className="flex justify-between items-start mb-8">
                <PlusCircle size={28} className="text-green-500 group-hover:rotate-90 transition-transform duration-500" />
              </div>
              
              {/* Bo góc tiêu đề "Trở thành đối tác" (Pill style) */}
              ...
              {/* Bo góc nút "Bắt đầu ngay" (Pill style) */}
          ...
          {/* CỘT 4: Kết nối cộng đồng - Icon bo góc vừa vặn */}
          <div className="space-y-10 lg:pl-10">
            <h5 className="font-bold text-[12px] text-green-500 uppercase tracking-[0.3em]">Kết nối cộng đồng</h5>
            
            <div className="flex flex-wrap gap-3">
              {[Facebook, Instagram, Youtube, Linkedin].map((Icon, i) => (
                <div key={i} className="w-12 h-12 bg-white/5 rounded-lg flex items-center justify-center cursor-pointer hover:bg-green-600 hover:text-white transition-all border border-white/5">
            ...
            <div className="pt-8 border-t border-white/5 space-y-5">
              ...
              <div className="flex flex-col gap-2.5">
                <div className="w-full h-11 bg-black rounded-lg border border-white/10 flex items-center justify-center text-[10px] font-bold tracking-widest hover:bg-gray-900 cursor-pointer transition-all uppercase">App Store</div>
                <div className="w-full h-11 bg-black rounded-lg border border-white/10 flex items-center justify-center text-[10px] font-bold tracking-widest hover:bg-gray-900 cursor-pointer transition-all uppercase">Google Play</div>
              </div>
            </div>
          </div>
      ...
      {/* Phần Copyright - Mỏng nhẹ & Tinh tế */}
      <div className="py-6 bg-black/40 border-t border-white/5">
        <div className="content-layout flex flex-col md:flex-row justify-between items-center gap-4 py-0">
          <p className="text-[9px] text-gray-500 font-semibold tracking-[0.3em] uppercase">
            © 2024 - 2026 BIKEHUB • PREMIUM ECOSYSTEM
          </p>
          <div className="flex gap-8 text-[9px] text-gray-600 font-semibold uppercase tracking-widest">
