...
export const locationService = {
     ...
     * POST /location
     */
    createLocation: async (payload: LocationCreatePayload): Promise<InspectionLocation | null> => {
        try {
     ...
     * PUT /location/{id}
     */
    updateLocation: async (id: number, payload: Partial<LocationCreatePayload>): Promise<InspectionLocation | null> => {
        try {
