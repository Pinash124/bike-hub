...
export const API_ENDPOINTS = {
  ...
  INSPECTION_AVAILABLE_INSPECTOR:
    API_BASE_URL + "/inspection/available-inspector", // GET ?scheduleAt=
  ...
  SUBSCRIPTION_BY_LISTING: (listingId: string) =>
    `${API_BASE_URL}/subscription/${listingId}`, // GET
  ...
  // ─── Order Log ─────────────────────────────────────────────────────────
  ORDER_LOG_BY_ORDER: (orderId: string) =>
    `${API_BASE_URL}/order-log/order/${orderId}`, // GET
  ORDER_LOG_BY_ID: (logId: string | number) =>
    `${API_BASE_URL}/order-log/${logId}`, // GET
  ...
  FAVORITE_DELETE: (listingId: string) =>
    `${API_BASE_URL}/favorite/${listingId}`, // DELETE
